...
export const InstagramApp = () => {
    ...
    const [optimisticComment, addOptimisticComment] = useOptimistic(comments,
        (currentComment, newComment: string) => {
            lastId++;
            return [
                ...currentComment,
                {
    ...
    const handleAddComment = async (formData: FormData) => {
        ...
        startTransition(async () => {
            ...
            //! En caso de error, se puede revertir el estado optimista
            setComments(prev => prev);
